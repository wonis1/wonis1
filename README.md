...
**RE:CALL**
<img src="./assets/recall-thumbnail.png" alt="RE:CALL login page thumbnail" width="320" align="left" />
...
- 바로가기: [GitHub 저장소](https://github.com/sw-2-2/recall-frontend) | [라이브 데모](https://recallhub.vercel.app/login?redirect=%2F)

<br clear="left" />

**AES Portfolio App**
<img src="./assets/aes-portfolio-thumbnail.png" alt="AES Portfolio App projects section thumbnail" width="320" align="left" />
...
- 바로가기: [GitHub 저장소](https://github.com/wonis1/AES-portfolio-app) | [라이브 데모](https://aes-portfolio-app.vercel.app/#about)
