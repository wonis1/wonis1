...
안녕하세요. 같은 문제를 두 번 고치기 싫어 구조부터 먼저 생각하는 프론트엔드 개발자 정재원입니다.<br/>
기능을 붙이는 속도보다 나중에 흔들림이 덜한 흐름을 만드는 일을 더 중요하게 생각합니다.
...
<details>
  <summary><strong>RE:CALL | </strong>동창생 탐색 프로젝트</summary>
  <br />
  <img src="./assets/recall-thumbnail.png" alt="RE:CALL login page thumbnail" width="520" />
</details>
...
<details>
  <summary><strong>AES Portfolio App | </strong>DB 연동 포트폴리오 웹앱 프로젝트</summary>
  <br />
  <img src="./assets/aes-portfolio-thumbnail.png" alt="AES Portfolio App projects section thumbnail" width="520" />
</details>
개인 포트폴리오 웹앱  
...
- 감정보다는 통계에 기반하여 행동합니다.
- 업무를 큰 그림을 그리고 단계적으로 세분화하여 진행합니다.
- 고객의 니즈를 파악하며, 고객 요구사항과 현실적인 한계의 간극을 좁히는 협상에 능합니다.
...
- 고객사 문의를 단순히 접수/전달만 하지 않고, 원인 구간을 먼저 정리한 뒤 내부 개발 조직과 조율
...
![Zustand](https://img.shields.io/badge/Zustand-4A3F35?style=flat-square&logoColor=white)
...
- 인천대학교 산업지능연구실 | 학부연구생 | 2022.01 - 2022.04
- 현대오토에버 모빌리티 SW 스쿨 3기 (웹&앱) | 교육생 | 2025.12 - 2026.06 (수료 예정)
